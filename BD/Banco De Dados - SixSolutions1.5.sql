...
fk_empresa int,    -- O ideal seria funcionário e estufa ser N para M mas, como não aprendemos ainda, cada funcionário só poderá trabalhar em uma estufa
nome varchar(60),
RG varchar (20),
login varchar(60),
senha varchar(60),
...
id_usuario_estufa int primary key auto_increment,
fk_usuario int,
fk_estufa int,
...
(null,2,1003),
(null,3,1003),
(null,4,1004), -- a usuaria Mariana com o id 4 é administradora, portanto tem acesso às duas estufas da empresa 3
(null,4,1006),
(null,5,1004),
(null,6,1004),
(null,6,1006); -- o usuario Joao de id 6 trabalha nas duas estufas da empresa 3
