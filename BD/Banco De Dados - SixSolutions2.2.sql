...
foreign key (fk_chefe) references usuarios(id_usuario)
);

insert into usuarios values      
(null,1,'Ricardo','35678959-0','login1','senha1','administrador',null),
(null,1,'Lucas','38475637-5','login2','senha2','funcionário',1),
(null,1,'José','34675681-5','login3','senha3','funcionário',1),
(null,3,'Mariana','45763476-4','login4','senha4','administrador',null),
(null,3,'Ana','23465478-9','login5','senha5','funcionário',4),
(null,3,'João','16457645-1','login6','senha6','funcionário',4);
...
(1,2,'2021-01-03','demora na atualização dos dados do site'),
(2,3,'2021-03-22','sensores de umidade da estufa Carolina - 1 pararam de funcionar');

select * from ocorrencias;

select * from usuarios join ocorrencias on fk_usuario=id_usuario;
select * from usuarios left join ocorrencias on fk_usuario=id_usuario;
...
create table sensores (
    ...
    identificacao char(10),
    fk_estufa int,
    constraint sensores_fk_estufa foreign key (fk_estufa) references Estufa(idEstufa)
);

insert into sensores (identificacao,fk_estufa) values -- insere 2 sensores na estufa de id 1000 e mais dois na 1001
('SS6B356755',1000),
('SS6B356756',1000),
('SS6B356757',1001),
('SS6B356758',1001);
