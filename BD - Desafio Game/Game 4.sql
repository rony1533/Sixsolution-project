...
-- com os quais eles batalharam, ordenados pelo ranking dos aventureiros (hard)
...
-- exibir o número total de moedas dropadas por monstros em todas as batalhas que todos os membros do clã das adagas voadoras venceram (coringa)
